...
For a simple working example please checkout the [examples/simple/simple.go](https://github.com/cameliot/alpaca/blob/master/examples/simple/simple.go) string reversal service.
